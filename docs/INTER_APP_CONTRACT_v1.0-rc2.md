# DEVIS SIGN-OFF WORKFLOW — INTER-APP CONTRACT v1.0-rc2

**Status:** Draft, pending Step 3 read-and-confirm by Archidoc and Archisign.
...
| `ARCHITRAK_WEBHOOK_SECRET` | Architrak (single value, distributed) | Archidoc (signer/receiver) | HMAC secret for Architrak → Archidoc webhooks (work-authorisation channel) | Rotation initiated by Architrak; 2-week dual-secret window; comma-separated list on Archidoc side during the window |
...
| Archidoc | R3 §6 + §7 + §7.3 + §7.4 | pending | — | — |
| Archisign | R3 §7.1–§7.7 + §8 | pending | — | — |

**Contract freezes at v1.0 when Archidoc and Archisign both reply `confirmed v1.0-rc2` (or higher rc tag).**

---

## End of consolidated contract v1.0-rc2
