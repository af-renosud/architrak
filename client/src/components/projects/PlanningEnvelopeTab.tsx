...
type Revision = { revision: { id: number; status: "draft" | "reviewed" | "approved" | "superseded"; reference: string; descriptionFr: string; documentDate?: string | null; amountHt: string; amountTtc: string; tvaRatePercent?: string | null; tvaAutoliquidation?: boolean; version: number; contractorId?: number | null; lotId?: number | null; archidocTechnicalLotId?: string | null; supersedesRevisionId?: number | null; promotedDevisId?: number | null; promotedAt?: string | null; updatedAt: string }; lines: Line[]; source: { sourceKind: "manual" | "pdf_upload"; fileName?: string | null; fileSha256?: string | null; confidence?: number | null; warnings?: { message?: string; severity?: string }[]; requiresVerification?: boolean; verifiedAt?: string | null; verificationNote?: string | null } | null; contractorName: string | null; lotNumber: string | null; technicalLot: TechnicalLot | null; legacyLotNeedsReview?: boolean };
...
export function PlanningEnvelopeTab({ projectId, contractors, isArchived }: Props) {
  ...
  const deleteDraft = useMutation({
    ...
    onError: (e: Error) => toast({
      title: "Uploaded devis could not be deleted",
