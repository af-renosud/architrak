...
function RevisionCard({ item, revisions, projectId, isArchived, isRescraping, onEdit, onReview, onAction, onRescrape, onPromote }: { item: Revision; revisions: Revision[]; projectId: string; isArchived: boolean; isRescraping: boolean; onEdit: () => void; onReview: () => void; onAction: (url: string, body?: unknown) => void; onRescrape: () => void; onPromote: () => void }) {
